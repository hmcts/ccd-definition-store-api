...
class UserRoleIT {
    ...
    @Autowired
    private ServiceAuthTokenGenerator serviceTokenGenerator;

    @BeforeEach
    void setup() {
        template = new JdbcTemplate(db);
        uriVariables = new HashMap<>();
        uriVariables.put("port", Integer.toString(8080)); // Replace with actual port
    }

    @Test
    @Sql(executionPhase = BEFORE_TEST_METHOD, scripts = {"classpath:sql/user_role.sql"})
    void shouldGetRole_whenRoleExists() throws Exception {
    ...
    @Test
    @Sql(executionPhase = BEFORE_TEST_METHOD, scripts = {"classpath:sql/user_role.sql"})
    void shouldHaveStatusCodeNotFound_whenRoleDoesNotExist() {
    ...
    @Test
    @Sql(executionPhase = BEFORE_TEST_METHOD, scripts = {"classpath:sql/user_role.sql"})
    void shouldHaveStatusCodeBadRequest_whenRoleIsNotBase64Encoded() {
    ...
    @Test
    @Sql(executionPhase = BEFORE_TEST_METHOD, scripts = {"classpath:sql/user_role.sql"})
    void shouldCreate_whenRoleDoesNotExist() {
    ...
    @Test
    @Sql(executionPhase = BEFORE_TEST_METHOD, scripts = {"classpath:sql/user_role.sql"})
    void shouldUpdate_whenRoleExists() {
