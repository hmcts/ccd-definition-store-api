...
class ReindexTaskTest {
    ...
    void shouldSerializeStartAndEndTimeUsingExpectedPattern() {
        ...
        task.setStartTime(LocalDateTime.of(2026, Month.APRIL, 28, 15, 0, 1));
        task.setEndTime(LocalDateTime.of(2026, Month.APRIL, 28, 16, 10, 59));
    ...
    void shouldDeserializeStartAndEndTimeUsingExpectedPattern() {
        ...
        assertThat(task.getStartTime(), is(equalTo(LocalDateTime.of(2026, Month.APRIL, 28, 15, 0, 1))));
        assertThat(task.getEndTime(), is(equalTo(LocalDateTime.of(2026, Month.APRIL, 28, 16, 10, 59))));
    }

    @Test
    void shouldCalculateDurationUsingSamePrecisionAsDisplayedTimes() {
        ReindexTask row1 = new ReindexTask();
        row1.setStartTime(LocalDateTime.of(2026, Month.MAY, 18, 16, 3, 44, 900_000_000));
        row1.setEndTime(LocalDateTime.of(2026, Month.MAY, 18, 16, 3, 46, 100_000_000));
        assertThat(row1.getDuration(), is(equalTo(2L)));

        ReindexTask row2 = new ReindexTask();
        row2.setStartTime(LocalDateTime.of(2026, Month.MAY, 18, 13, 59, 9, 800_000_000));
        row2.setEndTime(LocalDateTime.of(2026, Month.MAY, 18, 13, 59, 15, 300_000_000));
    ...
    void shouldReturnNullDurationWhenEndTimeIsNull() {
        ReindexTask task = new ReindexTask();
        task.setStartTime(LocalDateTime.of(2026, Month.APRIL, 30, 20, 34, 35));
