...
public class UserRoleRepositoryTest {
    ...
    public void shouldFindRole() {
        final UserRoleEntity role = repository.findTopByRole("xyz = '3'").get();
    ...
    public void shouldCreateRole() {
        ...
        final UserRoleEntity afterSave = repository.findTopByRole(role).get();
        assertThat(afterSave.getRole(), is(role));
    ...
    public void shouldUpdateLock_whenUpdate() {
        ...
        final UserRoleEntity afterSave = repository.findTopByRole("xyz = '3'").get();
    ...
    public void shouldFail_whenCreatedObjectIsUpdatedAgain() {
        ...
        final UserRoleEntity fetched = repository.findTopByRole(role).get();
    ...
    public void shouldFail_whenFectedObjectIsUpdatedAfterAnotherFind() {
        ...
        final UserRoleEntity fetchedAgain = repository.findTopByRole(role).get();
