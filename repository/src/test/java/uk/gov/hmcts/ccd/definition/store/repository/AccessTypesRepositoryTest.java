...
public class AccessTypesRepositoryTest {
    ...
    @Autowired
    private AccessTypesRespository accessTypesRespository;
    ...
    public void saveAndRetrieveAccessTypeRoles() {
        ...
        List<AccessTypeEntity> accessTypesList = accessTypesRespository.findAllWithCaseTypeIds();
    ...
    private AccessTypeEntity createAccessTypeEntity(CaseTypeEntity caseType) {
        ...
        accessTypes.setCaseTypeId(caseType);
    ...
    private void saveAccessTypeRoles(AccessTypeEntity accessTypes) {
        accessTypesRespository.save(accessTypes);
        entityManager.flush();
        entityManager.clear();
    }
}
