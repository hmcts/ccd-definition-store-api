...
public abstract class AbstractWriteDefinitionRepositoryDecorator<T extends DefEntity, ID extends Serializable, R extends WriteDefinitionRepository<T, ID>> implements
    WriteDefinitionRepository<T, ID> {

    protected R repository;

    protected AbstractWriteDefinitionRepositoryDecorator(R repository) {
