...
public interface GenericLayoutRepository extends DefinitionRepository<GenericLayoutEntity, Integer> {
    ...
    @Query("select wbcf from WorkBasketCaseFieldEntity wbcf where wbcf.caseType = ("
        + SELECT_LATEST_CASE_TYPE_ENTITY_FOR_REFERENCE + ")")
    List<WorkBasketCaseFieldEntity> findWorkbasketByCaseTypeReference(
        @Param("caseTypeReference") String caseTypeReference);

    @Query("select sicf from SearchInputCaseFieldEntity sicf where sicf.caseType = ("
        + SELECT_LATEST_CASE_TYPE_ENTITY_FOR_REFERENCE + ")")
    List<SearchInputCaseFieldEntity> findSearchInputsByCaseTypeReference(
        @Param("caseTypeReference") String caseTypeReference);

    @Query("select srcf from SearchResultCaseFieldEntity srcf where srcf.caseType = ("
        + SELECT_LATEST_CASE_TYPE_ENTITY_FOR_REFERENCE + ")")
    List<SearchResultCaseFieldEntity> findSearchResultsByCaseTypeReference(
        @Param("caseTypeReference") String caseTypeReference);
    ...
    List<SearchCasesResultFieldEntity> findSearchCasesResultsByCaseTypeReference(
        @Param("caseTypeReference") String caseTypeReference, @Param("useCase") String useCase);
