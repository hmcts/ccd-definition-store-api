@F-088
Feature: Fetch the UI definition for the work basket results for a given Case Type :: GET /api/display/work-basket-result-definition/{id}

  Background:
    Given an appropriate test context as detailed in the test data source

  @S-385 @Ignore @RDM-7618
  Scenario: must return the UI definition of work basket results for a given case type
    ...
    And it is submitted to call the [fetch UI definition for work basket results] operation of [CCD Definition Store]
