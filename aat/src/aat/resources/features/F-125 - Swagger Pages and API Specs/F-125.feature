...
Scenario: must show Swagger UI page APIs
    ...
    Given an appropriate test context as detailed in the test data source,
     ...
     Then a positive response is received,
      ...
      And a call [to observe the swagger UI content] will get the expected response as in [S-125_Swagger_UI].
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
@S-125.2
Scenario: must show Swagger Json APIs
    ...
    Given an appropriate test context as detailed in the test data source,
     ...
     Then a positive response is received,
      And the response has all the details as expected
      And a call [to observe the swagger json content] will get the expected response as in [S-125_Swagger_JSON].
