@F-083
Feature: Fetch the UI definition for the search inputs for a given Case Type :: GET /api/display/search-input-definition/{id}
  ...
  Scenario: must return the UI definition of search inputs for a given case type
    ...
    And it is submitted to call the [fetch UI definition for search inputs] operation of [CCD Definition Store]
