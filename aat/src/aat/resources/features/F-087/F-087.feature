@F-087
Feature: Fetch the UI definition for the work basket inputs for a given Case Type :: GET /api/display/work-basket-input-definition/{id}
  ...
  Scenario: must return the UI definition of work basket inputs for a given case type
    ...
    And it is submitted to call the [fetch UI definition for work basket inputs] operation of [CCD Definition Store]
