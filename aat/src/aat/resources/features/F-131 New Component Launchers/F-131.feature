@F-131
Feature: F-131: Test new base types Summary, Roles, Hearings and Task
  ...
  Scenario: Import Definition File with valid base types: Summary base type
    ...
    And a call [get tabs for case type id which has summary tab] will get the expected response as in [S-131.1_Get_Tab_Structure]
