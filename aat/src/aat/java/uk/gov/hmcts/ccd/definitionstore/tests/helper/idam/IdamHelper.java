...
public class IdamHelper {
    ...
    public AuthenticatedUser authenticate(String email, String password) {
        return users.computeIfAbsent(email, e -> {
            ...
            final OidcApi.IdamUser user = idamApi.getUser(accessToken);
    ...
    public String getIdamOauth2Token(String username, String password) {
        ...
        OidcApi.TokenResponse openIdTokenResponse = idamApi.generateOpenIdToken(
            GRANT_TYPE,
            oauth2.getClientId(),
