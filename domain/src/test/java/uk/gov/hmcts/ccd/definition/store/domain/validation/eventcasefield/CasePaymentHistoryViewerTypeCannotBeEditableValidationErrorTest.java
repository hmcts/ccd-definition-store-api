...
public class CasePaymentHistoryViewerTypeCannotBeEditableValidationErrorTest {
    ...
    private CasePaymentHistoryViewerTypeCannotBeEditableValidationError classUnderTest;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        when(mockValidationErrorMessageCreator.createErrorMessage(any(CasePaymentHistoryViewerTypeCannotBeEditableValidationError.class)))
            .thenReturn(OVERRIDDEN_ERROR_MESSAGE);
        classUnderTest = new CasePaymentHistoryViewerTypeCannotBeEditableValidationError(
            eventCaseFieldEntity(caseField("CasePaymentHistoryViewer"),event("EventId"))
        );
    }
    ...
    public void testDefaultMessage() {
        assertEquals(
            "'CasePaymentHistoryViewer' is CasePaymentHistoryViewer type and cannot be editable for event with reference 'EventId'",
