...
public class GenericLayoutEntityDisplayContextParameterValidatorImplTest {
    ...
    @ParameterizedTest
    @ArgumentsSource(EntityArgumentsProvider.class)
    void shouldFailValidationForInvalidDateTimeFormat(GenericLayoutEntity entity) throws Exception {
    ...
    @ParameterizedTest
    @ArgumentsSource(EntityArgumentsProvider.class)
    void shouldFailValidationForInvalidDisplayContextParameterType(GenericLayoutEntity entity) {
    ...
    @ParameterizedTest
    @ArgumentsSource(EntityArgumentsProvider.class)
    void shouldFailValidationForNotAllowedDisplayContextParameterType(GenericLayoutEntity entity) {
    ...
    @ParameterizedTest
    @ArgumentsSource(EntityArgumentsProvider.class)
    void shouldFailValidationForNotAllowedFieldType(GenericLayoutEntity entity) {
        entity.setDisplayContextParameter("#DATETIMEDISPLAY(hhmmss)");
        entity.setCaseField(caseFieldEntity(fieldTypeEntity(FieldTypeUtils.BASE_TEXT)));
