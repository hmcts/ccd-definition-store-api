...
//        final DefinitionDataItem item4 = new DefinitionDataItem(SEARCH_CASES_RESULT_FIELDS.getName());
//        item4.addAttribute(ColumnName.CASE_TYPE_ID, CASE_TYPE_ID);
//        item4.addAttribute(ColumnName.CASE_FIELD_ID, CASE_FIELD_ID_1);
//        item4.addAttribute(ColumnName.DISPLAY_ORDER, 3.0);
//        item4.addAttribute(ColumnName.USE_CASE, "String");
//        sheet1.addDataItem(item4);
//        final DefinitionDataItem item5 = new DefinitionDataItem(SEARCH_CASES_RESULT_FIELDS.getName());
//        item5.addAttribute(ColumnName.CASE_TYPE_ID, CASE_TYPE_ID2);
//        item5.addAttribute(ColumnName.CASE_FIELD_ID, CASE_FIELD_ID_2);
//        item5.addAttribute(ColumnName.DISPLAY_ORDER, 1.0);
//        item5.addAttribute(ColumnName.LIST_ELEMENT_CODE, LIST_ELEMENT_CODE_1);
//        item5.addAttribute(ColumnName.USER_ROLE, ROLE1);
//        item5.addAttribute(ColumnName.USE_CASE, "useCase");
//        sheet1.addDataItem(item5);
//        final DefinitionDataItem item6 = new DefinitionDataItem(SEARCH_CASES_RESULT_FIELDS.getName());
//        item6.addAttribute(ColumnName.CASE_TYPE_ID, CASE_TYPE_ID2);
//        item6.addAttribute(ColumnName.CASE_FIELD_ID, CASE_FIELD_ID_2);
//        item6.addAttribute(ColumnName.DISPLAY_ORDER, 1.0);
//        item6.addAttribute(ColumnName.LIST_ELEMENT_CODE, LIST_ELEMENT_CODE_1);
//        item6.addAttribute(ColumnName.USER_ROLE, ROLE1);
//        item6.addAttribute(ColumnName.USE_CASE, "useCase");
//        sheet1.addDataItem(item6);
//
//
//        definitionSheets.put(WORK_BASKET_RESULT_FIELDS.getName(), sheet);
//        definitionSheets.put(SEARCH_CASES_RESULT_FIELDS.getName(), sheet1);
//        UserRoleEntity userRoleEntity = new UserRoleEntity();
//        userRoleEntity.setReference(ROLE1);
//        context.registerUserRoles(Arrays.asList(userRoleEntity));
//        MapperException thrown = assertThrows(MapperException.class, () -> classUnderTest.parseAllSearchCases(definitionSheets));
//        assertEquals(String.format("Please make sure each row in worksheet %s is unique for case type %s",
//            item6.getSheetName(), item6.getString(ColumnName.CASE_TYPE_ID)), thrown.getMessage());
//
//        context.registerUserRoles(Arrays.asList(new UserRoleEntity()));
//    }
