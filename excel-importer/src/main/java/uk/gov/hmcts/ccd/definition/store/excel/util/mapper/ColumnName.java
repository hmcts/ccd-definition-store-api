...
public enum ColumnName {
    ...
    CALLBACK_GET_CASE_URL("CallbackGetCaseUrl"),
    ...
    RETRIES_GET_CASE_URL("RetriesGetCaseUrl"),
    ...
    CHALLENGE_QUESTION_IGNORE_NULL_FIELDS("IgnoreNULLFields"),
    ...
    ACCESS_MANDATORY("AccessMandatory"),
