    ...
    void shouldReturn200WhenFindDefinitions() throws Exception {
        ...
        assertThat(mvcResult.getResponse().getContentAsString(),
                   is("[{\"jurisdiction\":{\"id\":\"TEST\",\"name\":null,\"description\":null,\"live_from\":null," +
                       "\"live_until\":null,\"case_types\":[],\"banners\":[]},\"description\":\"Description\",\"version\":null," +
                       ...
                       "{\"jurisdiction\":{\"id\":\"TEST\",\"name\":null,\"description\":null,\"live_from\":null,\"live_until\":null,\"case_types\":[]," +
                       "\"banners\":[]},\"description\":\"Description\",\"version\":null,\"data\":{\"Data\":{\"Field1\":\"Value1\",\"Field2\":[]}}," +
                       "\"author\":\"ccd2@hmcts\",\"status\":null,\"case_types\":\"CaseType1,CaseType2\",\"created_at\":null,\"last_modified\":null," +
                       "\"deleted\":false}]"));
    }
    ...
    void shouldReturn200WhenFindByJurisdictionAndVersion() throws Exception {
        ...
        assertThat(mvcResult.getResponse().getContentAsString(),
                   is("{\"jurisdiction\":{\"id\":\"TEST\",\"name\":null,\"description\":null,\"live_from\":null,\"live_until\":null," +
                       "\"case_types\":[],\"banners\":[]},\"description\":\"Description\",\"version\":null," +
                       "\"data\":{\"Data\":{\"Field1\":\"Value1\",\"Field2\":[]}},\"author\":\"ccd2@hmcts\",\"status\":null," +
                       "\"case_types\":\"CaseType1,CaseType2\",\"created_at\":null,\"last_modified\":null,\"deleted\":false}"));
    }
