...
| DEFINITION_STORE_S2S_AUTHORISED_SERVICES | ccd_data,ccd_gw,ccd_admin,jui_webapp,pui_webapp,aac_manage_case_assignment,adoption_cos_api,adoption_web | Authorised micro-service names for S2S calls |
